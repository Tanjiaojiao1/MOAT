...
class City_Dataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        if (self.split == "train" or self.split == "trainval") and self.training:
            ...
            image_aug, gt_image_aug = self._train_sync_transform(img_aug, gt_img_aug)
        else:
            image, gt_image = self._val_sync_transform(image, gt_image)
            image_aug, gt_image_aug = image, gt_image

        return image, gt_image, image_aug, gt_image_aug, item
